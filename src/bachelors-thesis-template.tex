...
%Tema simulatsioonide kohaselt omab LoRa modulatsioon väiksemat bitiveategurit võrreldes digitaal-sagedusmodulatsiooniga.
    ...
    Litsentseeritud sagedusalas leidub NB\-/IoTga samaaegselt loodud LTE\-/M, mille puhul on sarnaselt tegemist LTE vähendatud kujuga\todo{roaming}.
    ...
    Erinevaid tehnoloogiaid korraga on kirjanduses katsetatud mitmel põhjusel.\todo{siinsed 2 näidet ei ühildu}
    ...
    FiPy on katsetes lõppseadme rollis, ehk simuleerib üksikut IoT seadet suhtlemas iga uuritava LPWANi võrgu tugijaamadega.\todo{pildid ja jutt kuidas transporditakse ja katsetatakse (autos ja kotis)}
...
% Katsete käigus kasutatakse lõppseadet, et luua side Sigfoxi, NORAneti, Telia NB-IoT ja isikliku LoRaWAN tugijaamaga strateegilistest kohtadest, mis on täpsemini kirjeldatud peatükis 4.3.
    ...
    \TODO{mingisugune üleminek järgmisesse peatükki??}
    ...
    \begin{figure} [ht]
        \begin{center}
            \includegraphics[width=0.95\textwidth]{figures/tugijamadzoom.png}
...
%            \hline
    ...
    NB-IoT välitingimustel probleeme ei tekitanud ning üleslink latents püsis pidevalt 0,3--0,5 sekundi vahemikus.\todo{updateda viimaste testidega, sai suurema latentsi ka kätte}
...
%\section*{\appendixname}
    ...
    \addcontentsline{toc}{subsection}{I. Testskript}
    \begin{spacing}{0.8}
