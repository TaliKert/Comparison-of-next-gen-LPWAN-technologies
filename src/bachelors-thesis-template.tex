...
\huge Uue generatsiooni LPWAN sidevõrkude võrdlus
...
Mina, \textbf{Kert Tali}, %author's name
...
\par
\textbf{PEALKIRI}, %title of thesis
    \licencehint{10mm}{lõputöö pealkiri}
\par
mille juhendaja on Alo Peets, %supervisor's name(s)
